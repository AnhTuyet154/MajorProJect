...
import com.example.quanlyactivity.interfaces.adapter.ChatAdapter;
...
public class ChatAdminActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        iduser = getIntent().getIntExtra("id", 0); //id nguoi nhan - id nguoi can chat
    ...
    private final EventListener<QuerySnapshot> eventListener = (value, error) -> {
        ...
        if (value != null) {
            ...
            // Sắp xếp danh sách bằng cách sử dụng thuộc tính datetime
