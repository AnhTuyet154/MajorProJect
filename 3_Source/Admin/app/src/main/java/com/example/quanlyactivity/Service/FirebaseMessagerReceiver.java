package com.example.quanlyactivity.Service;
...
import com.example.quanlyactivity.activities.MainActivity;
...
public class FirebaseMessagerReceiver extends FirebaseMessagingService {
    ...
    private void showNotification(String title, String body) {
        Intent intent = new Intent(this, QuanLyActivity.class);//mainactivity
