...
if($iduser == 0){
    ...
    //bai64
    /*$query = 'SELECT donhang.id,donhang.diachi,donhang.sodienthoai, donhang.email, donhang.soluong, donhang.tongtien, donhang.trangthai, donhang.momo,
    donhang.ngaydat,user.username FROM `donhang` INNER JOIN user ON donhang.iduser = user.id ORDER BY donhang.id DESC';*/
}else
{
